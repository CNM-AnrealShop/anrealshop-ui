...
export const BASE_API_URL =
  import.meta.env.VITE_BASE_API_URL || "http://localhost:4141/api";
export const BASE_BE_URL =
  import.meta.env.VITE_BASE_BE_URL || "http://localhost:4141";
export const MAX_IMAGE_SIZE = import.meta.env.VITE_MAX_IMAGE_SIZE;
export const BASE_FE_URL = import.meta.env.VITE_BASE_FE_URL;
export const GOOGLE_LOGIN_URL = `${BASE_API_URL}/oauth2/authorize/google`;
export const FACEBOOK_LOGIN_URL = `${BASE_API_URL}/oauth2/authorize/facebook`;
export const CLOUNDINARY_UPLOAD_PRESET = import.meta.env
...
export const API_ENDPOINTS = {
  AUTH: {
    ...
    SWITCH_TOKEN_TYPE: (type: UserRoleType) =>
      `/auth/switch-token-type?type=${type}`,
  ...
  ADMIN: {
    ...
    CATEGORY_SWITCH: (categoryId: string) =>
      `/admin/categories/${categoryId}/switch-status`,
  ...
  SHIPMENT: {
    ...
    MYSHOP_REJECT: (shippingId: string) =>
      `/shipping/my-shop/reject-shipping/${shippingId}`,
  },
  ...
  ORDERS: {
    ...
    MYSHOP_APPROVAL: (shopOrderId: string) =>
      `/my-shop/orders/approve/${shopOrderId}`,
    MYSHOP_REJECT: (orderItemId: string) =>
      `/my-shop/orders/reject-id/${orderItemId}`,
